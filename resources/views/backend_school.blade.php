...
<html lang="en">
    ...
    <head>
        ...
        <title>Running School ( School Administrator )</title>
        <base href="/backend_school/">
        ...
        <!-- / FUSE Splash Screen CSS -->
    <link rel="stylesheet" href="styles.6b67a90110eba7d7da33.css"></head>
    <body>
        <!-- FUSE Splash Screen -->
        ...
        <!-- / FUSE Splash Screen -->
        <app></app>
    <script type="text/javascript" src="runtime.26209474bfa8dc87a77c.js"></script><script type="text/javascript" src="polyfills.99ef70c40a65e1e7e619.js"></script><script type="text/javascript" src="main.101a3cd172f8db285b14.js"></script></body>
</html>
